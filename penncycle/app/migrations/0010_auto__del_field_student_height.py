...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Student.height'
        db.delete_column('app_student', 'height')


    def backwards(self, orm):
        
        # Adding field 'Student.height'
        db.add_column('app_student', 'height', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)
    ...
    models = {
        ...
        'app.student': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 3, 14)'}),

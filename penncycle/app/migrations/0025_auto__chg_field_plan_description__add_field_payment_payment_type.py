...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('app_plan', 'description', self.gf('django.db.models.fields.TextField')(max_length=150))

        # Adding field 'Payment.payment_type'
        db.add_column('app_payment', 'payment_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Plan.description'
        db.alter_column('app_plan', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Deleting field 'Payment.payment_type'
        db.delete_column('app_payment', 'payment_type')
    ...
    models = {
        ...
        'app.student': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 8, 1)'}),

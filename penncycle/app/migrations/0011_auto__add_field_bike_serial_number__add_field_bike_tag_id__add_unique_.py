...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bike.serial_number'
        db.add_column('app_bike', 'serial_number', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Bike.tag_id'
        db.add_column('app_bike', 'tag_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding unique constraint on 'Bike', fields ['bike_name']
        db.create_unique('app_bike', ['bike_name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Bike', fields ['bike_name']
        db.delete_unique('app_bike', ['bike_name'])

        # Deleting field 'Bike.serial_number'
        db.delete_column('app_bike', 'serial_number')

        # Deleting field 'Bike.tag_id'
        db.delete_column('app_bike', 'tag_id')

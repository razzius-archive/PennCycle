...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('app_student', 'last_two', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))


    def backwards(self, orm):
        
        # Changing field 'Student.last_two'
        db.alter_column('app_student', 'last_two', self.gf('django.db.models.fields.CharField')(default='', max_length=2))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Student.last_two'
        db.add_column('app_student', 'last_two', self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Student.last_two'
        db.delete_column('app_student', 'last_two')
    ...
    models = {
        ...
        'app.student': {
            ...
            'last_two': ('django.db.models.fields.CharField', [], {'max_length': '2', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bike.combo'
        db.add_column('app_bike', 'combo', self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True), keep_default=False)

        # Adding field 'Bike.combo_update'
        db.add_column('app_bike', 'combo_update', self.gf('django.db.models.fields.DateField')(default=datetime.date(2013, 2, 24)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bike.combo'
        db.delete_column('app_bike', 'combo')

        # Deleting field 'Bike.combo_update'
        db.delete_column('app_bike', 'combo_update')
    ...
    models = {
        ...
        'app.student': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 2, 24)'}),

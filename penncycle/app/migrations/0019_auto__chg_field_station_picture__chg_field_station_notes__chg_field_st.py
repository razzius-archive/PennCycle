...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Station.picture'
        db.alter_column(u'app_station', 'picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Station.notes'
        db.alter_column(u'app_station', 'notes', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))

        # Changing field 'Station.hours'
        db.alter_column(u'app_station', 'hours', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))

        # Changing field 'Station.address'
        db.alter_column(u'app_station', 'address', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Station.picture'
        raise RuntimeError("Cannot reverse this migration. 'Station.picture' and its values cannot be restored.")

        # Changing field 'Station.notes'
        db.alter_column(u'app_station', 'notes', self.gf('django.db.models.fields.TextField')(default='', max_length=100))

        # Changing field 'Station.hours'
        db.alter_column(u'app_station', 'hours', self.gf('django.db.models.fields.TextField')(default='', max_length=100))

        # Changing field 'Station.address'
        db.alter_column(u'app_station', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=300))
    ...
    models = {
        ...
        u'app.station': {
            ...
            'hours': ('django.db.models.fields.TextField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'app.student': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 30, 0, 0)'}),
            ...
            'pin': ('django.db.models.fields.CharField', [], {'default': "'1317'", 'max_length': '4'}),
            'school': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),

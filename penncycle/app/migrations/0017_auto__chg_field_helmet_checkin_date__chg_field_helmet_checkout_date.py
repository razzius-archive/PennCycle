...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Helmet.checkin_date'
        db.alter_column(u'app_helmet', 'checkin_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Helmet.checkout_date'
        db.alter_column(u'app_helmet', 'checkout_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Helmet.checkin_date'
        raise RuntimeError("Cannot reverse this migration. 'Helmet.checkin_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Helmet.checkout_date'
        raise RuntimeError("Cannot reverse this migration. 'Helmet.checkout_date' and its values cannot be restored.")
    ...
    models = {
        ...
        u'app.student': {
            ...
            'pin': ('django.db.models.fields.CharField', [], {'default': "'1893'", 'max_length': '4'}),

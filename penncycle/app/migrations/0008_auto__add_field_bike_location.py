...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bike.location'
        db.add_column(u'app_bike', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['app.Station']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bike.location'
        db.delete_column(u'app_bike', 'location_id')
    ...
    models = {
        ...
        u'app.student': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 1, 0, 0)'}),

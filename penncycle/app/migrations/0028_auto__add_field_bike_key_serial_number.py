...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bike.key_serial_number'
        db.add_column('app_bike', 'key_serial_number', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bike.key_serial_number'
        db.delete_column('app_bike', 'key_serial_number')
    ...
    models = {
        ...
        'app.student': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 26)'}),

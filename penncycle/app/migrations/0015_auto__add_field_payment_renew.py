...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.renew'
        db.add_column(u'app_payment', 'renew',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.renew'
        db.delete_column(u'app_payment', 'renew')
    ...
    models = {
        ...
        u'app.student': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 24, 0, 0)'}),
            ...
            'pin': ('django.db.models.fields.CharField', [], {'default': "'5230'", 'max_length': '4'}),

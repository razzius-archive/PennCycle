...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('app_ride', 'num_users')


    def backwards(self, orm):
        
        # Adding field 'Ride.num_users'
        db.add_column('app_ride', 'num_users', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_page', 'slug', self.gf('django.db.models.fields.SlugField')(default='fake', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.slug'
        db.delete_column('app_page', 'slug')

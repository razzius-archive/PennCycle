...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.pin'
        db.add_column(u'app_student', 'pin',
                      self.gf('django.db.models.fields.CharField')(default='4240', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.pin'
        db.delete_column(u'app_student', 'pin')
    ...
    models = {
        ...
        u'app.student': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 8, 0, 0)'}),
            ...
            'pin': ('django.db.models.fields.CharField', [], {'default': "'1641'", 'max_length': '4'}),

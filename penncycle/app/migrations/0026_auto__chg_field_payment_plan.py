...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('app_payment', 'plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Plan']))


    def backwards(self, orm):
        
        # Changing field 'Payment.plan'
        db.alter_column('app_payment', 'plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Plan'], null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'app_payment', 'payment_type', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
        ...
        db.alter_column(u'app_student', 'school', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Student.major'
        db.alter_column(u'app_student', 'major', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):

        # Changing field 'Payment.payment_type'
        db.alter_column(u'app_payment', 'payment_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Station.address'
        db.alter_column(u'app_station', 'address', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Student.school'
        db.alter_column(u'app_student', 'school', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Student.major'
        db.alter_column(u'app_student', 'major', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'app.payment': {
            ...
            'payment_type': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        u'app.student': {
            ...
            'pin': ('django.db.models.fields.CharField', [], {'default': "'7510'", 'max_length': '4'}),

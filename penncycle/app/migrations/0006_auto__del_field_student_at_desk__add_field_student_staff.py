...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('app_student', 'at_desk')

        # Adding field 'Student.staff'
        db.add_column('app_student', 'staff', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Student.at_desk'
        db.add_column('app_student', 'at_desk', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Student.staff'
        db.delete_column('app_student', 'staff')
    ...
    models = {
        ...
        'app.student': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 4, 28)'}),

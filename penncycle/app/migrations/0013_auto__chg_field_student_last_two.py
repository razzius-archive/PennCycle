...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.last_two'
        db.alter_column(u'app_student', 'last_two', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Student.last_two'
        db.alter_column(u'app_student', 'last_two', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
    ...
    models = {
        ...
        u'app.student': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 19, 0, 0)'}),
            ...
            'pin': ('django.db.models.fields.CharField', [], {'default': "'3060'", 'max_length': '4'}),

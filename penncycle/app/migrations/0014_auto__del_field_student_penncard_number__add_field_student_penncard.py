...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Student.penncard_number'
        db.delete_column('app_student', 'penncard_number')

        # Adding field 'Student.penncard'
        db.add_column('app_student', 'penncard', self.gf('django.db.models.fields.CharField')(default='00000000', unique=True, max_length=8), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Student.penncard_number'
        db.add_column('app_student', 'penncard_number', self.gf('django.db.models.fields.CharField')(default='00000000', max_length=8, unique=True), keep_default=False)

        # Deleting field 'Student.penncard'
        db.delete_column('app_student', 'penncard')

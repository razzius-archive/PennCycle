...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_payment', 'status', self.gf('django.db.models.fields.CharField')(default='available', max_length=100), keep_default=False)

        # Deleting field 'Student.status'
        db.delete_column('app_student', 'status')


    def backwards(self, orm):
        
        # Deleting field 'Payment.status'
        db.delete_column('app_payment', 'status')

        # Adding field 'Student.status'
        db.add_column('app_student', 'status', self.gf('django.db.models.fields.CharField')(default='available', max_length=100), keep_default=False)
    ...
    models = {
        ...
        'app.student': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 9)'}),

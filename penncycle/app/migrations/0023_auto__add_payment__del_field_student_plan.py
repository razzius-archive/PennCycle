...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_payment', (
            ...
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Plan'], null=True, blank=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Student'])),

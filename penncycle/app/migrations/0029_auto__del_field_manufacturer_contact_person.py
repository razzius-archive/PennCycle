...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Manufacturer.contact_person'
        db.delete_column('app_manufacturer', 'contact_person')


    def backwards(self, orm):
        
        # Adding field 'Manufacturer.contact_person'
        db.add_column('app_manufacturer', 'contact_person', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    ...
    models = {
        ...
        'app.student': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 29)'}),

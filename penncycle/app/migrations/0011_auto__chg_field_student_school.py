...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Student.school'
        db.alter_column(u'app_student', 'school', self.gf('django.db.models.fields.CharField')(default='O', max_length=100))
    ...
    models = {
        ...
        u'app.student': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 11, 0, 0)'}),
            ...
            'pin': ('django.db.models.fields.CharField', [], {'default': "'5817'", 'max_length': '4'}),

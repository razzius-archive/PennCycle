...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Student', fields ['phone']
        db.create_unique(u'app_student', ['phone'])


    def backwards(self, orm):
        # Removing unique constraint on 'Student', fields ['phone']
        db.delete_unique(u'app_student', ['phone'])
    ...
    models = {
        ...
        u'app.student': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 10, 0, 0)'}),
            ...
            'pin': ('django.db.models.fields.CharField', [], {'default': "'8399'", 'max_length': '4'}),
